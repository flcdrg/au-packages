...
function global:au_GetLatest {
    ...
    $download = $response.downloads | Where-Object { $_.Featured -and $_.category__slug -eq "software" -and $_.filename.EndsWith(".exe") -and ([version] $_.version -lt $nextVersion) } | Select-Object -First 1
