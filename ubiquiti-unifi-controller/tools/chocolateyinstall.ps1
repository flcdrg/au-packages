...
$url        = 'https://fw-download.ubnt.com/data/unifi-os-server/b632-windows-arm64-msi-5.1.40-a6f79101-84b6-41b1-9d08-d1adc262dfce.exe'
$checksum   = '1ebb775b39576194093cd584d2fc012dd5c04c9991bde530eea743adc76213f3'
