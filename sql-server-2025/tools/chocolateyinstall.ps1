...
if ([Version] (Get-CimInstance Win32_OperatingSystem).Version -lt [version] "10.0.0.0") {
  Write-Error "SQL Server 2025 requires a minimum of Windows 10 or Windows Server 2016"
}
...
if (!$pp['PID']) {
  #  <Setting Id="FREEEDITIONS" Value="[00000-00000-00000-00000-00000, Evaluation], [22222-00000-00000-00000-00000, Enterprise Developer], [33333-00000-00000-00000-00000, Standard Developer], [11111-00000-00000-00000-00000, Express]" Source="Default" IsApplicable="true" IsChangeableByUser="false" />
  # Default to Developer Enterprise edition PID
  $pp['PID'] = "22222-00000-00000-00000-00000"
}
...
$packageArgs = @{
  ...
  softwareName  = 'Microsoft SQL Server 2025 (64-bit)'
  checksum      = 'F78F869D44E8C2CBF93BE16CE6EA52DD811636F046DED29E7A74DD1352134851'
  checksumType  = 'sha256'
...
if (!$pp['IsoPath']) {
  ...
  $fileFullPath = Join-Path $tempDir "SQLServer2025-x64-ENU.iso"
