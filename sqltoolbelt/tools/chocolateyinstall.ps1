...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2023-06-14/SQLToolbelt.exe'
$checksum = 'D81E478D1A3C9C63C5421E25026794EFCE799BD6A685052C2E805DA0C6B7A3A9'
