...
$url = 'https://download.red-gate.com/installers/SQLToolbelt/2025-10-07/SQLToolbelt.exe'
$checksum = 'E33546E4CA7FC441DED8234B9296258A69A14760928236A3EFEBBD60C1F61787'
